...
# Import dataset
df = pd.read_csv(r'C:\Users\Z0172725\datasets\apartement_data\apartment\2016\Apt2_2016.csv')
...
plt.show()
# map_val = mean_average_precision.MetricBuilder.get_metrics_list(Y_val_minmax, lstm_valid_pred)
# map_train = mapk(Y_train_minmax, lstm_train_pred)
# print(map_train, map_val)
